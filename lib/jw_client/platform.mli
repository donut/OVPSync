...
module type Client = sig
  val call 
    ...
    -> (Cohttp.Response.t * Cohttp_lwt.Body.t) Lib.Lwt_result.t

  val accounts_templates_list 
     : ?params : param list -> unit
    -> accounts_templates_list_body Lib.Lwt_result.t

  val videos_conversions_create 
     : string -> string 
    -> unit Lib.Lwt_result.t

  val videos_conversions_delete : string -> unit Lib.Lwt_result.t

  val videos_conversions_list 
    : string -> videos_conversions_list_body Lib.Lwt_result.t

  val videos_list 
     : ?params : param list -> unit 
    -> videos_list_body Lib.Lwt_result.t

  val videos_show 
     : string 
    -> videos_show_body option Lib.Lwt_result.t
